...
$obat_array = array(
    'obat0' => array('1', '4', '7', '000'),
    'obat1' => array('1', '4', '7', '111'),
    'obat2' => array('1', '4', '7', '222'),
    'obat3' => array('1', '4', '7', '333'),
    'obat4' => array('1', '4', '7', '444'),
);
foreach ($obat_array as $row => $value) {
    $apoteker_id = mysqli_real_escape_string($con, $value[0]);
    ...
    $sql = "INSERT INTO resep_apoteker(`apoteker_id`,`resep_id`, `obat_id`,`dosis`) 
    VALUES ('" . $apoteker_id . "','" . $resep_id . "', '" . $obat_id . "', '" . $dosis . "')";
